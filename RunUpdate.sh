...
if [ "$masterip" == "$myip" ];then
 ...
 #master pi
	if [ "$myip" == 192.168.1.101 ];then
		 ...
		 ./RenewContainer.sh lab3agritechpaloit/cratedb >> /home/pi/logs/$LogFileNameRenewCont
		 #1st Pi
		 ...
		 ssh -l pi 192.168.1.101 /home/pi/Lab3AgritechCron/RenewContainer.sh lab3agritechpaloit/cratedb >> /home/pi/logs/$LogFileNameRenewCont
